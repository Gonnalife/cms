...
<?php  foreach($list as $k => $v): ?>
      ...
      <td align="center"><a href="/cms/Admin.php/Home/User/manager_save?id= <?php echo $v['uid']; ?>">编辑</a> | <a href="/cms/Admin.php/Home/User/manager_del?id= <?php echo $v['uid']; ?>">删除</a></td>
     </tr>
<?php  endforeach; ?>
