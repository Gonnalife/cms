...
<!-- dcHead 结束 --> <div id="dcLeft"><div id="menu">
 ...
 <div id="dcMain">
   <!-- 当前位置 -->
<div id="urHere">CMS 管理中心<b>></b><strong>文章列表</strong> </div>   <div class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
        <h3><a href="<?php echo U('Article/addarticle');?>" class="actionBtn add">添加文章</a>文章列表</h3>
    <div class="filter">
    ...
    <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
     <tr>
      ...
      <th width="150" align="center">文章描述</th>
      <th width="80" align="center">添加日期</th>
      <th width="80" align="center">操作</th>
     </tr>
        <?php foreach($data as $v){ ?>
          <tr>
      <td align="center"><input type="checkbox" name="checkbox[]" value="<?php echo $v['wid']; ?>" /></td>
      <td align="center"><?php echo $v['wid']; ?></td>
      <td><a href="article.php?rec=edit&id=9"><?php echo $v['title']; ?></a></td>
      <td align="center"><a href="article.php?cat_id=2"><?php echo $v['works']; ?></a></td>
      <td align="center"><?php echo $v['uptime']; ?></td>
      <td align="center">
              <a href="/cms/index.php/Admin/Article/updateArticle?id=<?php echo $v['wid']; ?>">编辑</a> | <a href="/cms/index.php/Admin/Article/delArticle?id=<?php echo $v['wid']; ?>">删除</a>
             </td>
     </tr>
    <?php } ?>
         </table>
