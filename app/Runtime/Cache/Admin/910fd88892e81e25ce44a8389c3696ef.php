...
<?php if(!empty($_SESSION)): ?><li class="M noLeft"><a href="#">  <?php echo $_SESSION['username'] ?> </a>
  <?php else: ?>
      <li class="M noLeft"><a href="<?php echo U('Login/login');?>">您好，admin</a><?php endif; ?> 
...
<div id="menu">
 ...
 <ul>
  ...
  <li><a href="<?php echo U('Navs/nav');?>"><i class="nav"></i><em>自定义导航栏</em></a></li>
  ...
  <li><a href="<?php echo U('User/manager');?>"><i class="manager"></i><em>网站管理员</em></a></li>
...
<div id="urHere">DouPHP 管理中心<b>></b><strong>网站管理员</strong> </div>   <div id="manager" class="mainBox" style="height:auto!important;height:550px;min-height:550px;">
    <h3><a href="<?php echo U('User/manager_add');?>" class="actionBtn">添加管理员</a>网站管理员</h3>
...
<?php  foreach($list as $k => $v): ?>
      ...
      <td align="center"><a href="/cms/index.php/Admin/User/manager_save?id= <?php echo $v['uid']; ?>">编辑</a> | <a href="/cms/index.php/Admin/User/manager_del?id= <?php echo $v['uid']; ?>">删除</a></td>
     </tr>
<?php  endforeach; ?>
